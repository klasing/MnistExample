...
//void
//write_logfile(
//	const std::string& LOGGING_FILE_NAME,
//	const tuple_logging& tl
//)
//{
//	boost::filesystem::path p = { LOGGING_FILE_NAME };
...
//	//ofs << boost::tuples::set_delimiter('#') << tl;
//	//ofs.close();
//	write_logfile(LOGGING_FILE_NAME, tl);
//	// read tuple from file
//	tuple_logging tlin{ current_gmt, remote_endpoint,
//		request, response, elapsed_time };
//	//boost::filesystem::ifstream ifs{ p };
//	//ifs >> boost::tuples::set_delimiter('#') >> tlin;
//	//ifs.close();
//	read_logfile(LOGGING_FILE_NAME, tlin);
//	std::cout << tlin << '\n';
//	// get file size
//	boost::filesystem::path p = { LOGGING_FILE_NAME };
//	boost::system::error_code ec;
...
//	write_logfile(LOGGING_FILE_NAME, tl);
//	// clear file if too big
//	clear_logfile_if_too_big(LOGGING_FILE_NAME, LOGGING_BYTES_MAX);
//}

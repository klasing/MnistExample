...
#include "do_get_ip_net_table.cpp"
...
namespace ns_http_server_async {
	//***************************************************************************
	//*                    mime_type
	//***************************************************************************
	...
	class session : public std::enable_shared_from_this<session> {
		// This is the C++ equivalent of a generic lambda.
	...
	public:
		listener(
			...
			, doc_root_(doc_root) {
			cout << "<<constructor>> listener()" << endl;
	...
	inline int http_server_async(int argc, char* argv[]) {
		...
		auto const threads = max<int>(1, atoi(argv[4]));

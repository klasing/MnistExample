...
namespace ns_chapter_4_11 {
	...
	// the Car class is unchanged even though the algorithm is different
	// in PrintVisitor and DoVisitor.
...
inline void chapter_4_11() {
	cout << "Visitor" << endl;
	cout << "-------" << endl;

	using namespace ns_chapter_4_11;
	Car car;
